# Production Web Stories

First-hand accounts from my work supporting, testing, maintaining, and improving production WordPress and WooCommerce platforms.

Each story uses a simple Situation–Task–Action–Result structure. The emphasis is on what I personally did, how I approached the problem, and what changed. Client-sensitive data, credentials, and private operational details are intentionally excluded.
...
I am a Web Application Support & QA Engineer focused on WordPress, WooCommerce, and production operations. I work across issue reproduction, requirements, integrations, functional and regression testing, releases, incident recovery, documentation, and user handover.

[View my GitHub profile](https://github.com/zpthanos)
